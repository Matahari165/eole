    ...
    <div className="page-stack stats-page">
      ...
      <section className="content-card chart-card">
        ...
        <div className="chart-wrap" aria-hidden="true">
          <div className="chart-inner"><ResponsiveContainer width="100%" height="100%"><AreaChart accessibilityLayer={false} data={series} margin={{ top: 12, right: 8, left: -20, bottom: 0 }}><defs><linearGradient id="retentionFill" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#176f65" stopOpacity={0.22} /><stop offset="100%" stopColor="#176f65" stopOpacity={0.01} /></linearGradient></defs><CartesianGrid vertical={false} stroke="#d9e4df" /><XAxis dataKey="label" axisLine={false} tickLine={false} tick={{ fill: "#5f726c", fontSize: 12 }} /><YAxis axisLine={false} tickLine={false} tick={{ fill: "#5f726c", fontSize: 12 }} unit="s" /><Tooltip content={<RetentionTooltip />} /><Area type="monotone" dataKey="averageRetention" stroke="#176f65" strokeWidth={2.5} fill="url(#retentionFill)" connectNulls /></AreaChart></ResponsiveContainer></div>
        </div>
      </section>
